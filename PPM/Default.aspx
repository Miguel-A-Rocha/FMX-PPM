...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upPanel" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <asp:Timer ID="Unnamed" runat="server" Interval="10000" Enabled="false" OnTick="Unnamed_Tick"></asp:Timer>
            ...
            <div class="row w-100">
                                    ...
                                    <div class="card border-dark shadow">
                                        ...
                                        <div class="card-body p-1">
                                            <div class="table-responsive">
                                                <asp:GridView ID="gvPrograma" runat="server" GridLines="None" AutoGenerateColumns="false" CssClass="table table-borderless table-sm small table-hover small w-100"
                                                    ...
                                                    <Columns>
                                                        <%----%>
                                                        <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="pb-0"><%--ItemStyle-CssClass="p-0 m-0"--%>
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="No. Parte" HeaderStyle-CssClass="text-wrap" ItemStyle-CssClass="pb-0"><%--ItemStyle-CssClass="p-0 m-0"--%>
                                                            <ItemTemplate>
                                                                <div class="input-group input-group-sm m-0 p-0">
                                                        ...
                                                        <asp:TemplateField HeaderText="" ShowHeader="false">
                                                            <ItemTemplate>
                                                                <table cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td class='<%# (Eval("EstatusPrensa.nombre").ToString() == "OK" ? "" : "input-group-text bg-danger text-white small p-1") %>'><%# (Eval("EstatusPrensa.nombre").ToString() == "OK" ? "" : Eval("EstatusPrensa.nombre").ToString()) %></td>
                ...
                <div class="col-2">
                    <div class="row mb-2">
                        <div class="col">
                            <div class="card small border-secondary shadow shadow-lg">
                                <div class="card-header bg-danger">
                                    <span class="text-center fw-bold text-white">Estatus de Aceros</span>
                                </div>
                                <div class="card-body p-1">
                                    <asp:GridView ID="gvAceros" runat="server" DataKeyNames="id" CssClass="table table-sm small table-hover small w-100" GridLines="None" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No hay registros para el dia seleccionado">
                    ...
                    <div class="row mb-2">
                        <div class="col">
                            <div class="card small">
                                ...
                                <div class="card-body">
                                    <asp:GridView ID="gvEstatus" runat="server" ShowHeader="false" DataKeyNames="id" CssClass="table table-sm small small w-100" GridLines="None" AutoGenerateColumns="false">
                                        <Columns>
